...
const UserPromptCard = ({ message, showIndicator = false }: { message: { type: "user_prompt"; prompt: string; attachments?: { id: string; name: string; size: number; url: string; kind: "image" | "file" }[] }; showIndicator?: boolean }) => (
  <div className="flex flex-col mt-4">
    <div className="header text-accent flex items-center gap-2">
      <StatusDot variant="success" isActive={showIndicator} isVisible={showIndicator} />
      User
